...
function learnCharitableGame(arr){
    if (arr.reduce((curr,total) => curr+total,0) === 0){
        return false
    }
    return arr.reduce((curr,total) => curr+total,0)%arr.length === 0
}

console.log(learnCharitableGame([0,56,100]))
console.log(learnCharitableGame([100,100,100,90,1,0,0]))
console.log(learnCharitableGame([0,0,0,0]))
