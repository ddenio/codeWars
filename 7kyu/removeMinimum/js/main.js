...
function removeSmallest(numbers) {
    let arrMinIndex = numbers.indexOf(Math.min(...numbers))
    let result = numbers.slice(0,arrMinIndex).concat(numbers.slice(arrMinIndex + 1));
    return result
  }

console.log(removeSmallest([2,3,1,5,6]))