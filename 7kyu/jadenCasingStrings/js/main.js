...
String.prototype.toJadenCase = function () {
    let this2 = this.split(' ')
    let finalStr = ""
    for(let i = 0; i< this2.length;i++){
        finalStr += this2[i][0].toUpperCase()+this2[i].slice(1)+" "
    }return finalStr.trim()
  };

const testString = "welcome one and all";
const jadenCasedString = testString.toJadenCase();
console.log(jadenCasedString)
